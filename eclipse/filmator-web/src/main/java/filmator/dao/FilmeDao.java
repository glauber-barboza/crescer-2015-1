...
import filmator.model.Genero;
	...
	public class FilmeDao {
		...
		/*
		 * create table FILME(idFilme integer not null auto_increment,
nome varchar(100) not null,
datalancamento varchar(50) not null,
sinopse varchar(50) not null,
caminhoimg varchar(200) not null,
gênero varchar(100) not null);
		...
		public List<Filme> buscaTodosFilmes() {
			return jdbcTemplate.query("SELECT nome,datalancamento,sinopse,caminhoimg, genero FROM Filme",
							(ResultSet rs, int rowNum) -> {
								Filme filme = new Filme(rs.getString("nome"), rs
										.getString("sinopse"), rs
										.getString("caminhoimg"),
										rs.getString("datalancamento"),
										Enum.valueOf(Genero.class, rs.getString("genero")));
								return filme;
							});
		}
